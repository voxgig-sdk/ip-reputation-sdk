...
_runner = makeRunner(TEST_JSON_FILE, IpReputationSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IpReputationSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IpReputationSDK.test(None, setup.get('a') or {})
