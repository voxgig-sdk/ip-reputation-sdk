...
class IpReputationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpReputationTestRunner.getenv("IPREPUTATION_TEST_LIVE")
        override = IpReputationTestRunner.getenv("IPREPUTATION_TEST_OVERRIDE")
        ...
        explain = IpReputationTestRunner.getenv("IPREPUTATION_TEST_EXPLAIN")
