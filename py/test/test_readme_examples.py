# IpReputation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpReputationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpReputationSDK(...) and IpReputationSDK.test(...) become
#      IpReputationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipreputation_sdk"
_SDK_CLASS = "IpReputationSDK"
