...
from ipreputation_sdk.core.helpers import get_ctx_prop, to_map
...
class IpReputationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, IpReputationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, IpReputationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IpReputationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IpReputationError(code, msg, self)
