...
// IpReputation SDK streaming feature
...
class IpReputationStreamingFeature extends IpReputationBaseFeature
{
    ...
    private function _iterate(IpReputationResult $result): \Generator
    {
    ...
    private function _streamable(IpReputationContext $ctx): bool
    {
