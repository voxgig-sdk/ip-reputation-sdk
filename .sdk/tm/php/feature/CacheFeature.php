...
// IpReputation SDK cache feature
...
class IpReputationCacheFeature extends IpReputationBaseFeature
{
    ...
    private function _through(IpReputationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
