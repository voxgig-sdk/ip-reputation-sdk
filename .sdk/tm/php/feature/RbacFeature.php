...
class IpReputationRbacFeature extends IpReputationBaseFeature
{
    ...
    private function _required(IpReputationContext $ctx): ?string
    {
    ...
    private function _reject(IpReputationContext $ctx, string $required): void
    {
    ...
    private function _track(IpReputationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
