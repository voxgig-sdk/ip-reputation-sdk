...
// IpReputation SDK clienttrack feature
...
class IpReputationClienttrackFeature extends IpReputationBaseFeature
{
    ...
    public function PostConstruct(IpReputationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpReputation-SDK';
