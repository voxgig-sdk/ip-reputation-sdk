...
// IpReputation SDK timeout feature
...
class IpReputationTimeoutFeature extends IpReputationBaseFeature
{
    ...
    private function _with_timeout(IpReputationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpReputationContext $_ctx, float $ms): void
    {
        $client = $this->client;
