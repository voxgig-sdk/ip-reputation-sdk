...
// IpReputation SDK utility: graphql
//
...
class IpReputationGraphql
{
    ...
    // equivalent.
    public static function body(IpReputationContext $ctx): mixed
    {
    ...
    public static function errors(IpReputationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
