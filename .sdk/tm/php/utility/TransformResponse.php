...
// IpReputation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IpReputationTransformResponse
{
    public static function call(IpReputationContext $ctx): mixed
    {
        ...
        $transform = IpReputationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
