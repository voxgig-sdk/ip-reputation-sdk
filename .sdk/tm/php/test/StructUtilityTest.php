...
// IpReputation SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpReputationOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpReputationOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpReputationOmni::structfix($val, Struct::undef()))) {
