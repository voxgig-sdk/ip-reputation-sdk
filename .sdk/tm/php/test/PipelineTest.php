...
// IpReputation SDK pipeline test
//
...
{
    private static function utility(): IpReputationUtility
    {
        return new IpReputationUtility();
    }
    ...
    private static function ctx(array $over = []): IpReputationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpReputationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpReputationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpReputationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpReputationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpReputationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpReputationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpReputationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpReputationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpReputationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpReputationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpReputationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpReputationResponse([]),
            'result' => new IpReputationResult([]),
        ]);
        [, $err] = IpReputationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpReputationSpec([]),
            'response' => null,
            'result' => new IpReputationResult([]),
        ]);
        [, $err] = IpReputationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpReputationSpec(['step' => 's']),
            'response' => new IpReputationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpReputationResult([]),
        ]);
        [, $err] = IpReputationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpReputationSpec(['step' => 's']),
            'response' => new IpReputationResponse(self::resp(200, ['v' => 1])),
            'result' => new IpReputationResult([]),
        ]);
        [, $err] = IpReputationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpReputationSpec(['step' => 's']),
            'response' => new IpReputationResponse(self::resp(200, ['v' => 2])),
            'result' => new IpReputationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpReputationMakeResponse::call($ctx);
    ...
    {
        $preset = new IpReputationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpReputationSpec([]),
            'response' => new IpReputationResponse([]),
            'result' => new IpReputationResult([]),
        ...
        [$got, $err] = IpReputationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpReputationResult([])]);
        [, $err] = IpReputationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpReputationSpec([]), 'result' => null]);
        [, $err] = IpReputationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpReputationSpec(['step' => 's']),
            'result' => new IpReputationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpReputationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpReputationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpReputationSpec(['step' => 's']),
            'result' => new IpReputationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpReputationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpReputationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpReputationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpReputationSpec([]),
            'result' => new IpReputationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpReputationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpReputationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpReputationError('boom', 'boom');
        $utility->fetcher = function (IpReputationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpReputationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpReputationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpReputationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpReputationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpReputationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IpReputationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpReputationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpReputationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpReputationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpReputationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpReputationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpReputationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpReputationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpReputationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpReputationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpReputationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpReputationResult(['ok' => false])]);
        $this->expectException(IpReputationError::class);
        IpReputationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpReputationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpReputationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpReputationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpReputationBaseFeature();
        $b = new IpReputationBaseFeature();
        IpReputationFeatureAdd::call($ctx, $a);
        IpReputationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpReputationBaseFeature
    {
        $f = new IpReputationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpReputationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IpReputationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IpReputationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpReputationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        IpReputationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpReputationResponse(['headers' => null]),
            'result' => new IpReputationResult([]),
        ]);
        IpReputationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IpReputationResultBody::call($ctx);
