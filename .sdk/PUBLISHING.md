...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-reputation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ip-reputation-sdk \
      --repository voxgig-sdk/ip-reputation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ip-reputation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ip-reputation-sdk --id=<id>` removes it.
