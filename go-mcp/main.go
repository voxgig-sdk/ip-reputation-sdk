// Command IpReputation-mcp is an MCP server exposing the IpReputation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpReputation_list  — list records of an entity
//	IpReputation_load  — load a single record of an entity
//
