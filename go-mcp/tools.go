...
type Args struct {
	Entity string         `json:"entity" jsonschema:"detail | ip_reputation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpReputationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-reputation_list",
		Description: "List records from IpReputation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-reputation_load",
		Description: "Load a single record from IpReputation. " +
...
func runOp(client *sdk.IpReputationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpReputationSDK, name string) (sdk.IpReputationEntity, error) {
	switch strings.ToLower(name) {
	case "detail":
		return client.Detail(nil), nil
	case "ip_reputation":
