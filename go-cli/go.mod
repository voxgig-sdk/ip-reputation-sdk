module github.com/voxgig-sdk/ip-reputation-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/ip-reputation-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/ip-reputation-sdk/go => ../go
