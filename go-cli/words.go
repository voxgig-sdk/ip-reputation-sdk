...
func registerSDKWords(r *eng.Registry, client *sdk.IpReputationSDK) {
...
func runOp(client *sdk.IpReputationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
