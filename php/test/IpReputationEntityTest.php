...
class IpReputationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IPREPUTATION_TEST_IP_REPUTATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ip_reputation_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IPREPUTATION_TEST_IP_REPUTATION_ENTID");
