...
// IpReputation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpReputationSDK::test)
...
{
    private const SDK_CLASS = 'IpReputationSDK';
    ...
    private const SDK_BASE = 'ipreputation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipreputation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
