...
class DetailDirectTest extends TestCase
{
    public function test_direct_load_detail(): void
    {
        $setup = detail_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
