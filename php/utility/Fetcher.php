...
// IpReputation SDK utility: fetcher

class IpReputationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpReputationSDK/1.0)';
    ...
    public static function call(IpReputationContext $ctx, string $fullurl, array $fetchdef): array
    {
