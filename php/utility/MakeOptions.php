...
// IpReputation SDK utility: make_options

class IpReputationMakeOptions
{
    ...
    public static function call(IpReputationContext $ctx): array
    {
        ...
        //
        // `IpReputationSchema::optspec()` is built from the model:
        ...
        $optspec = IpReputationSchema::optspec();
