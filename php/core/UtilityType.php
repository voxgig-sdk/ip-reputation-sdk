...
// IpReputation SDK utility type

class IpReputationUtility
{
    ...
    public static function copy(IpReputationUtility $src): IpReputationUtility
    {
        $u = new IpReputationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
