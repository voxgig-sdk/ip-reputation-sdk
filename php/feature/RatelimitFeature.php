...
// IpReputation SDK ratelimit feature
...
class IpReputationRatelimitFeature extends IpReputationBaseFeature
{
    ...
    private function _acquire(IpReputationContext $ctx): void
    {
    ...
    private function _track(IpReputationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
