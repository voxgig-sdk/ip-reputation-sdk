...
// IpReputation SDK idempotency feature
...
class IpReputationIdempotencyFeature extends IpReputationBaseFeature
{
    ...
    private function _mutating(IpReputationContext $ctx): bool
    {
