...
// IpReputation SDK proxy feature
...
class IpReputationProxyFeature extends IpReputationBaseFeature
{
    ...
    public function init(IpReputationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpReputationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
