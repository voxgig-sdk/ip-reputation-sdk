...
// IpReputation SDK audit feature
...
class IpReputationAuditFeature extends IpReputationBaseFeature
{
    ...
    private function _emit(IpReputationContext $ctx, string $outcome): void
    {
