...
// IpReputation SDK netsim feature
...
class IpReputationNetsimFeature extends IpReputationBaseFeature
{
    ...
    private function _simulate(IpReputationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpReputationContext $ctx, array $applied): void
    {
        $client = $this->client;
