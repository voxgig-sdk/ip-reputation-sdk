...
// IpReputation SDK metrics feature
...
class IpReputationMetricsFeature extends IpReputationBaseFeature
{
    ...
    private function _record(IpReputationContext $ctx, bool $ok): void
    {
