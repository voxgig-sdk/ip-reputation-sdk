# IpReputation PHP SDK



The PHP SDK for the IpReputation API — an entity-oriented client using PHP conventions.
...
```
php/
├── ipreputation_sdk.php          -- Main SDK class
...
The main class (`ipreputation_sdk.php`) exports the SDK class
