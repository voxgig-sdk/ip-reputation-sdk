...
(0, node_test_1.describe)('DetailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpReputationSDK({
    ...
    (0, node_test_1.test)('direct-load-detail', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-detail', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_REPUTATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpReputationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.IP_REPUTATION_APIKEY,
        }));
        let idmap = env['IP_REPUTATION_TEST_DETAIL_ENTID'];
    ...
    const client = new __1.IpReputationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DetailDirect.test.js.map