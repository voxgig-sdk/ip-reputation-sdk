...
(0, node_test_1.describe)('IpReputationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'ip_reputation.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['ip_reputation01', 'ip_reputation02', 'ip_reputation03', 'score01', 'score02', 'score03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
