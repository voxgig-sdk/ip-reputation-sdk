...
#      offline in seeded test mode (IpReputationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpReputation_sdk.rb")
  SDK_CLASS = "IpReputationSDK"
