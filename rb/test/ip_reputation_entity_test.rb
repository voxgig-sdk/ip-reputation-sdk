...
class IpReputationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IP_REPUTATION_TEST_IP_REPUTATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ip_reputation_basic_setup(extra)
  ...
  entid_env_raw = ENV["IP_REPUTATION_TEST_IP_REPUTATION_ENTID"]
