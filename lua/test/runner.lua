...
function runner.env_override(m)
  local live = runner.getenv("IP_REPUTATION_TEST_LIVE")
  local override = runner.getenv("IP_REPUTATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IP_REPUTATION_TEST_EXPLAIN")
