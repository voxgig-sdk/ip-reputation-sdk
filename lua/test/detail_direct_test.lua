...
describe("DetailDirect", function()
  it("should direct-load-detail", function()
    local setup = detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-detail", setup.live and "live" or "unit")
...
function detail_direct_setup(mockres)
