...
func TestDetailEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set IP_REPUTATION_TEST_DETAIL_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func detailBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("IP_REPUTATION_TEST_DETAIL_ENTID")
