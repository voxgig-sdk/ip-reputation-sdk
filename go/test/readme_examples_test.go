...
const testSeed = `map[string]any{"entity": map[string]any{"detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ip_reputation": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
