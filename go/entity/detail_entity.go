...
func NewDetailEntity(client *core.IpReputationSDK, entopts map[string]any) *DetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DetailEntity) GetName() string { return e.name }
...
func (e *DetailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DetailEntity) Deleted() bool {
	return e.deleted
}


func (e *DetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDetailEntity(e.client, opts)
}

func (e *DetailEntity) Data(args ...any) any {
...
func (e *DetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Detail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DetailEntity) DataTyped(data ...Detail) Detail {
	if len(data) > 0 {
		return typedFrom[Detail](e.Data(asMap(data[0])))
	}
	return typedFrom[Detail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Detail (all fields
// optional at the wire level).
func (e *DetailEntity) MatchTyped(match ...Detail) Detail {
	if len(match) > 0 {
		return typedFrom[Detail](e.Match(asMap(match[0])))
	}
	return typedFrom[Detail](e.Match())
}
...
func (e *DetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DetailEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DetailLoadMatch and returns an Detail. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DetailEntity) LoadTyped(reqmatch DetailLoadMatch, ctrl map[string]any) (Detail, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Detail{}, err
	}
	return typedFrom[Detail](res), nil
}



func (e *DetailEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DetailEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DetailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DetailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
