...
func (sdk *IpReputationSDK) OptionsMap() map[string]any {
...
func (sdk *IpReputationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpReputationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpReputationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpReputationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpReputationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpReputationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpReputationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpReputationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpReputationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpReputationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
// Detail returns a Detail entity bound to this client.
// Idiomatic usage: client.Detail(nil).List(nil, nil) or
// client.Detail(nil).Load(map[string]any{"id": ...}, nil).
func (sdk *IpReputationSDK) Detail(data map[string]any) IpReputationEntity {
	return NewDetailEntityFunc(sdk, data)
}
...
func (sdk *IpReputationSDK) IpReputation(data map[string]any) IpReputationEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpReputationSDK {
	...
	sdk := NewIpReputationSDK(sdkopts)
	sdk.Mode = "test"
